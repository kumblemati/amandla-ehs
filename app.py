...
# Use query params for navigation if available
try:
    query_params = st.query_params
    nav_page = query_params.get("page", ["Home"])[0]
except:
    nav_page = "Home"
...
page = st.sidebar.radio(
    ...
    index=["Home", "Dashboard", "Incident Register", "Add Incident", "Site Management", "Import Data", "Settings"].index(nav_page) if nav_page in ["Home", "Dashboard", "Incident Register", "Add Incident", "Site Management", "Import Data", "Settings"] else 0
)
...
if page == "Home":
    ...
    with col1:
        st.markdown("""
        <div style="text-align: center; padding: 2rem; border: 2px solid #1f4e79; border-radius: 10px; margin: 0.5rem;">
            <h2>📊</h2>
    ...
    with col2:
        st.markdown("""
        <div style="text-align: center; padding: 2rem; border: 2px solid #f5576c; border-radius: 10px; margin: 0.5rem;">
            <h2>🚨</h2>
    ...
    with col3:
        st.markdown("""
        <div style="text-align: center; padding: 2rem; border: 2px solid #43e97b; border-radius: 10px; margin: 0.5rem;">
            <h2>📤</h2>
            <h3>Import Data</h3>
...
# ─── INCIDENT REGISTER ───
    ...
    if filtered:
        ...
        # NEW COLUMNS: Incident date, Employee name, ID, Site, Employment type, Division, Description, Preventative action, Body part, Cause, Injury type, Days away
