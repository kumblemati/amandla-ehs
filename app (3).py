...
if page == "Home":
    ...
    with col2:
        ...
        if st.button("Add Incident", key="btn_inc", use_container_width=True):
            st.session_state.nav_target = "Add Incident"
    ...
    with col3:
        ...
        if st.button("Import Data", key="btn_imp", use_container_width=True):
            st.session_state.nav_target = "Import Data"
...
# ─── INCIDENT REGISTER ───
    ...
    with col_if2:
        reg_type_filter = st.selectbox("Type", ["All", "Lost Time Injury", "Medical Treatment", "First Aid"], index=0)
